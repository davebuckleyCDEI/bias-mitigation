...
This section goes into more detail on testing for bias and applying definitions of fairness to the data sets. It therefore requires a higher level of technical comprehension.
...
[binder-finance-baseline]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Ffinance%2Fbaseline.ipynb "Open notebook on Binder"
[binder-recruiting-baseline]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Frecruiting%2Fbaseline.ipynb "Open notebook on Binder"
