...
<CookieConsent
    ...
    We use analytics cookies to send information about how our site is used to Google Analytics.
    <br/><br/>We use this information to improve our site. Let us know if this is OK. We'll use a cookie to save your choice.
</CookieConsent>
...
We applied the intervention to the adult dataset in order to impose different notions of fairness with respect to sex. Run our analysis yourself on [Binder][binder-finance-ftu].
...
Here we applied the intervention to the synthetic recruiting dataset and impose different notions of fairness with respect to race. Run our analysis yourself on [Binder][binder-recruiting-ftu].
...
[Pleiss et al.][pleiss] introduce a post-processing algorithm that imposes a relaxed notion of equalised odds while preserving calibration. It is one of the few methods available that targets multiple notions of fairness simultaneously. It is implemented in [IBM's AI Fairness 360][aif-360].
...
[Agarwal et al.][agarwal] introduce an in-processing technique which learns a fair classifier by solving a constrained minimisation problem. It is implemented in [FairLearn][fairlearn] library.
...
We applied the intervention to the adult dataset in order to impose different notions of fairness with respect to sex. Run our analysis yourself on Binder [here][binder-finance-agarwal].
...
Here we applied the intervention to the synthetic recruiting dataset and impose different notions of fairness with respect to race. Run our analysis yourself on Binder [here][binder-recruiting-agarwal].
...
[binder-finance-agarwal]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Ffinance%2Finterventions%2Fagarwal.ipynb "Open notebook on Binder"
[binder-finance-feldman]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Ffinance%2Finterventions%2Ffeldman.ipynb "Open notebook on Binder"
[binder-finance-ftu]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Ffinance%2Finterventions%2Fftu.ipynb "Open notebook on Binder"
[binder-finance-hardt]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Ffinance%2Finterventions%2Fhardt.ipynb "Open notebook on Binder"
[binder-finance-kamiran]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Ffinance%2Finterventions%2Fkamiran.ipynb "Open notebook on Binder"
[binder-finance-kamiran-calders]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Ffinance%2Finterventions%2Fkamiran_calders.ipynb "Open notebook on Binder"
[binder-finance-kamishima]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Ffinance%2Finterventions%2Fkamishima.ipynb "Open notebook on Binder"
[binder-finance-pleiss]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Ffinance%2Finterventions%2Fpleiss.ipynb "Open notebook on Binder"
[binder-finance-zemel-race]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Ffinance%2Finterventions%2Fzemel_race.ipynb "Open notebook on Binder"
[binder-finance-zemel-sex]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Ffinance%2Finterventions%2Fzemel_sex.ipynb "Open notebook on Binder"
[binder-finance-zhang]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Ffinance%2Finterventions%2Fzhang.ipynb "Open notebook on Binder"
[binder-recruiting-agarwal]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Frecruiting%2Finterventions%2Fagarwal.ipynb "Open notebook on Binder"
[binder-recruiting-feldman]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Frecruiting%2Finterventions%2Ffeldman.ipynb "Open notebook on Binder"
[binder-recruiting-ftu]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Frecruiting%2Finterventions%2Fftu.ipynb "Open notebook on Binder"
[binder-recruiting-hardt]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Frecruiting%2Finterventions%2Fhardt.ipynb "Open notebook on Binder"
[binder-recruiting-kamiran]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Frecruiting%2Finterventions%2Fkamiran.ipynb "Open notebook on Binder"
[binder-recruiting-kamiran-calders]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Frecruiting%2Finterventions%2Fkamiran_calders.ipynb "Open notebook on Binder"
[binder-recruiting-kamishima]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Frecruiting%2Finterventions%2Fkamishima.ipynb "Open notebook on Binder"
[binder-recruiting-pleiss]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Frecruiting%2Finterventions%2Fpleiss.ipynb "Open notebook on Binder"
[binder-recruiting-zemel]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Frecruiting%2Finterventions%2Fzemel.ipynb "Open notebook on Binder"
[binder-recruiting-zhang]: https://mybinder.org/v2/gh/CDEIUK/bias-mitigation/master?filepath=notebooks%2Frecruiting%2Finterventions%2Fzhang.ipynb "Open notebook on Binder"
